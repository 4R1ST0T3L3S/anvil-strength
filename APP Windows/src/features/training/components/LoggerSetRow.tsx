...
export function LoggerSetRow({
    ...
    return (
        <div className={cn('transition-colors duration-fast', done && 'bg-[var(--success-quiet)]')}>
            ...
            <div className="grid grid-cols-[1rem_1fr_1fr_2.75rem_2.25rem_2.75rem] items-center py-2 gap-1.5 px-3">
                {/* Número de serie */}
                <span
                    className={cn(
            ...
            {setType && (
                <div className="flex items-baseline gap-2 pb-2 px-3 pl-[2rem]">
            ...
            {onOpenVbt && (
                <div className="pb-1.5 px-3 pl-[2rem]">
                    <button
                        onClick={onOpenVbt}
                        className={cn(
