...
export function SessionFinish({
 ...
 : 'bg-success-quiet text-success'
                ...
                {done && checkInDone === false && (
                    <div className="border-t border-subtle bg-surface-sunken p-5">
                ...
                {done && checkInDone === null && (
                    <div className="flex items-center gap-2 border-t border-subtle bg-surface-sunken py-3 text-t-xs text-ink-subtle px-5">
