        ...
        <div className="mx-auto w-full max-w-5xl text-ink">
            ...
            <div className="sticky top-0 z-sticky border-b border-subtle bg-surface-canvas/95 backdrop-blur">
                ...
                {selectedWeek !== null ? (
                    <div className="px-4 pt-3">
                        <div className="flex items-stretch gap-1.5">
                            <button
                                ...
                                className="flex min-w-0 flex-1 items-center justify-between gap-2 rounded-xl bg-surface-raised text-left transition-colors hover:bg-surface-overlay disabled:hover:bg-surface-raised px-3 py-2.5"
                            >
                                <span className="flex min-w-0 items-center gap-2">
                                    ...
                                    <span className="min-w-0">
                                        ...
                                        <span className="block truncate text-t-sm font-bold leading-tight">
                                            ...
                                            <span className="ml-1.5 font-normal text-ink-subtle inline">
                                                {formatDateRange(
                    ...
                    <h1 className="text-t-xs font-bold uppercase tracking-widest text-brand-text px-4 pt-3">
                        {block.name}
                    </h1>
                )}
                ...
                {/* Renglón 2: los días.
                    ...
                    existe. */}
                <div className="flex overflow-x-auto py-2 scrollbar-hide gap-2.5 px-4">
                    {sessions.map(s => {
...
function LoggerExerciseCard({
    ...
    return (
        <div className="bg-surface-canvas rounded-card overflow-hidden border border-subtle shadow-sm">
            ...
            {!isCardio && (
                <div className="grid grid-cols-[1rem_1fr_1fr_2.75rem_2.25rem_2.75rem] border-b border-subtle bg-surface-overlay/40 py-2 text-center text-t-2xs font-bold uppercase tracking-wide text-ink-subtle gap-1.5 px-3">
