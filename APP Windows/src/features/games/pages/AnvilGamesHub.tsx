...
export function AnvilGamesHub({ user }: AnvilGamesHubProps) {
    ...
    if (activeGameId) {
        ...
        return (
            <div className="fixed inset-0 z-50 bg-black flex flex-col p-4">
                <div className="flex-1 w-full max-w-md mx-auto max-h-[850px]">
                    <GameComponent 
                        user={user} 
    ...
    return (
        <main className="pt-28 pb-24 w-full min-h-[100dvh] px-12">
            {/* Header */}
            <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                    <h1 className="font-black uppercase italic text-ink text-4xl">Anvil Games</h1>
            ...
            <section className="mb-12">
                ...
                <div 
                    ...
                    className="relative overflow-hidden rounded-3xl bg-surface-sunken border border-line cursor-pointer group hover:border-purple-500/50 transition-[border-color,transform] active:scale-[0.98]"
                >
                    <div className="absolute inset-0 bg-gradient-to-br from-purple-900/20 to-transparent z-0"></div>
                    
                    <div className="relative z-10 p-8 flex items-center gap-8 flex-row">
                    ...
                    <div className="grid gap-4 grid-cols-3">
                        {GAMES.map(game => (
                            <div 
                                ...
                                className={`bg-surface-sunken border ${game.border} rounded-2xl p-6 cursor-pointer hover:bg-surface-sunken transition-colors flex flex-col justify-between`}
                            >
                                <div>
