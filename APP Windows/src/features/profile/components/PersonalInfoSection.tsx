...
export function PersonalInfoSection({ athleteId, mode, coachId, editorId }: PersonalInfoSectionProps) {
    ...
    return (
        <section className="overflow-hidden rounded-card border border-[var(--border-default)] bg-surface-raised">
            <header className="flex items-center justify-between gap-3 border-b border-subtle py-3 px-5">
            ...
            {fields.length === 0 ? (
                <p className="py-8 text-center text-t-sm text-ink-subtle px-5">
                    {mode === 'coach'
                ...
                <>
                    ...
                    {dirty && (
                        <div className="flex items-center gap-2 border-t border-subtle bg-surface-sunken py-3 px-5">
                            <Button
                                variant="primary"
                                size="md"
...
function FieldEditor({
    ...
    return (
        <section className="overflow-hidden rounded-card border border-[var(--border-default)] bg-surface-raised">
            ...
            <div className="flex flex-wrap items-center gap-2 border-t border-subtle bg-surface-sunken py-3 px-5">
