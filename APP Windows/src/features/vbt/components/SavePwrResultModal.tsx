    ...
    return (
        <AnimatePresence>
            <m.div
                ...
                className="fixed inset-0 z-[250] flex justify-center bg-black/75 backdrop-blur-sm items-center p-4"
                onClick={onClose}
            >
                <m.div
                    ...
                    className="flex max-h-[92vh] w-full max-w-lg flex-col overflow-hidden border border-subtle bg-surface-raised shadow-overlay rounded-card"
                >
                    ...
                    <div className="min-h-0 flex-1 space-y-4 overflow-y-auto p-4">
                        ...
                        {!fixedAthleteId && (
                            <div>
                                ...
                                <div className="grid max-h-44 gap-1 overflow-y-auto grid-cols-2">
