    ...
    return (
        <AnimatePresence>
            <m.div
                ...
                className="fixed inset-0 z-[240] flex justify-center bg-black/75 backdrop-blur-sm items-center p-4"
                onClick={onClose}
            >
                <m.div
                    ...
                    className="flex max-h-[92vh] w-full max-w-md flex-col overflow-hidden border border-subtle bg-surface-raised shadow-overlay rounded-card"
                >
