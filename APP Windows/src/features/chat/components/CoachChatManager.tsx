...
export function CoachChatManager({ coach }: { coach: UserProfile }) {
    ...
    return (
        <div className="min-h-[100dvh] bg-surface-sunken p-12">
            <header className="mb-10 flex justify-between gap-6 flex-row items-center">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="font-black uppercase italic text-ink text-3xl">Mensajería</h1>
