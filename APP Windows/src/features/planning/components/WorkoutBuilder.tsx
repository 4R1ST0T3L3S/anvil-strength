...
export function WorkoutBuilder({ athleteId, blockId, athleteName, onDirtyChange }: WorkoutBuilderProps) {
        ...
        <div className="relative">
            ...
            <div className="w-full pt-10 px-12">
                <div className="flex flex-col gap-6">
                    <div className="flex justify-between gap-3 flex-row items-end">
                        ...
                        <div className="flex shrink-0 flex-wrap items-center gap-2 self-auto">
 ...
 : 'text-ink-subtle hover:text-ink'
            ...
            {view === 'overview' && (
                <div className="w-full pb-24 pt-8 px-12">
                    <BlockOverviewPanel
            ...
            {/* Weeks List */}
            <div className={`w-full space-y-4 pb-24 px-12 ${view === 'plan' ? '' : 'hidden'}`}>
                    ...
                    return (
                        ...
                        >
                            ...
                            <div
                                ...
                                className="flex cursor-pointer items-center justify-between rounded-card transition-colors duration-fast ease-snap hover:bg-surface-overlay focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-brand gap-4 px-5 py-5"
                            >
                                    ...
                                    <div className="min-w-0">
                                        {editingWeek === week ? (
                                            ...
                                            <div className="group flex min-w-0 items-baseline gap-2">
                                                <h3 className="truncate font-semibold text-ink text-t-lg">
                                                    Semana {index + 1}
                                                    {weekName(week) && (
                                        ...
                                        <div className="flex items-center gap-x-2 gap-y-0.5 overflow-hidden text-t-xs text-ink-subtle mt-1 flex-wrap whitespace-normal">
                                            <span>
                                                {formatDateRange(
                                            ...
                                            {stats && stats.tonnage > 0 && (
                                                <>
                                                    <span className="text-ink-faint inline" aria-hidden="true">·</span>
                                                    <span className="tabular-nums inline">{(stats.tonnage / 1000).toFixed(1)} t</span>
                                                </>
                                            )}
                                            {stats?.avgRpe != null && (
                                                <>
                                                    <span className="text-ink-faint inline" aria-hidden="true">·</span>
                                                    <span className="tabular-nums inline">RPE {stats.avgRpe}</span>
                                                </>
                                            )}
                                ...
                                <div className="flex shrink-0 items-center gap-1">
                                    {isCurrent && (
                                        <span className="mr-1 rounded-chip bg-brand-quiet px-2 py-0.5 text-t-2xs font-semibold text-brand-text inline">
                                            En curso
                                        </span>
                                    )}
                                    {isDeload && (
                                        <span className="mr-1 rounded-chip bg-info/15 px-2 py-0.5 text-t-2xs font-semibold text-info inline">
                                            Descarga
                                        </span>
                                    )}
                            ...
                            <div className={`grid overflow-hidden rounded-b-card transition-[grid-template-rows] duration-base ease-snap ${isExpanded ? 'grid-rows-[1fr]' : 'grid-rows-[0fr]'}`}>
                                <div className="overflow-hidden">
                                    <div className="border-t border-[var(--border-subtle)] p-6">
                                        <div className="grid 2xl:grid-cols-4 gap-4 grid-cols-3">
