    ...
    return (
        <AnimatePresence>
            <m.div
                ...
                className="fixed inset-0 z-[220] flex justify-center bg-black/70 backdrop-blur-sm items-center p-4"
                onClick={onClose}
            >
                <m.div
                    ...
                    className="flex max-h-[85vh] w-full max-w-lg flex-col overflow-hidden border border-subtle bg-surface-raised shadow-overlay rounded-card"
                >
