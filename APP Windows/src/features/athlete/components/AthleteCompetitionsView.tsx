...
export function AthleteCompetitionsView({ user }: AthleteCompetitionsViewProps) {
    ...
    return (
        <div className="w-full space-y-12 px-12 py-8">
            <header>
                <h1 className="font-black uppercase tracking-tighter mb-2 text-ink flex items-center gap-4 text-5xl">
                        ...
                        {upcoming.map((comp) => {
                            ...
                            return (
                                <div key={comp.id} className="relative group">
                                    ...
                                    <div className={`${getCompetitionColorClass(comp.level)} rounded-[2rem] flex gap-6 justify-between transition-[box-shadow,transform] hover:scale-[1.01] hover:shadow-2xl p-8 flex-row items-center`}>
                                        <div className="space-y-4">
                                            ...
                                            <div>
                                                <h3 className="font-black text-ink uppercase tracking-tight mb-2 text-3xl">
                                                    {comp.name}
                                                </h3>
                                                <div className="flex text-white/80 flex-row items-center gap-6">
