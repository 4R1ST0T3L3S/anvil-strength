...
export function AthleteNutritionView({ user }: AthleteNutritionViewProps) {
    ...
    if (!plan) {
        return (
            <div className="w-full space-y-8 animate-fade px-12 py-8">
                <header>
                    <h1 className="font-black uppercase tracking-tighter mb-2 text-ink text-5xl">Mi Nutrición</h1>
                            ...
                            return (
                                <div key={meal.id} className="bg-surface-sunken border border-subtle rounded-card overflow-hidden hover:border-[var(--border-default)] transition-colors">
                                    ...
                                    >
                                        ...
                                        <div className="flex items-center gap-4">
                                            <div className="gap-3 text-xs text-ink-subtle flex">
