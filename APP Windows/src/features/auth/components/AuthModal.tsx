...
interface AuthModalProps {
  ...
  /**
   * Sin capa oscura ni botón de cerrar: la tarjeta a secas, para pintarla
   * dentro de una pantalla (la de entrada). `onClose` no hace nada ahí.
   */
  inline?: boolean;
}

export function AuthModal({ isOpen, onClose, initialMode = 'login', inline = false }: AuthModalProps) {
