...
export function SistemaPreview() {
    ...
    return (
        <div className="min-h-[100dvh] bg-surface-canvas py-8 px-8">
            <div className="mx-auto w-full max-w-4xl space-y-12">
                ...
                >
                    <form onSubmit={enviar} noValidate className="grid gap-4 grid-cols-2">
                        ...
                        <Textarea
                            ...
                            campo={notas}
                            maximo={120}
                            contenedorClassName="col-span-2"
                ...
                >
                    <Tabs
                        ...
                        pestanas={[
                            ...
                            { id: 'estadisticas', label: 'Estadísticas', insignia: 3 },
