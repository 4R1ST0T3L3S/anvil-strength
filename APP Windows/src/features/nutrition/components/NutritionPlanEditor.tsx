...
export function NutritionPlanEditor({ athleteId }: NutritionPlanEditorProps) {
    ...
    return (
        <div className="space-y-8 animate-fade">
            ...
            <div className="bg-surface-sunken border border-line rounded-2xl p-6 relative overflow-hidden">
                ...
                {!plan && !isEditingMacros ? (
                    ...
                    <div className="grid gap-4 relative z-10 grid-cols-4">
                        <div>
                        ...
                        <div className="flex justify-end gap-2 mt-2 col-span-4">
                            {plan && (
                                <button 
