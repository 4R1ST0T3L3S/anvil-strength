...
export function PreferencesPage({ coachId, onOpenPdfTheme, isDeveloper = false }: {
    ...
    return (
        <div className="mx-auto w-full max-w-3xl space-y-6 pb-24 pt-4 px-0">
            {/* DOCUMENTO PDF.
            ...
            {onOpenPdfTheme && (
                <button
                    ...
                    className="group flex w-full items-center gap-4 rounded-card border border-[var(--border-default)] bg-surface-raised text-left transition-colors duration-fast ease-snap hover:border-[var(--border-strong)] hover:bg-surface-overlay p-6"
                >
