            ...
            <div className="w-full px-12 py-8">
                ...
                <header className="mb-6 flex items-center gap-3">
                    ...
                    <div className="min-w-0">
                        <h1 className="truncate font-black uppercase tracking-display text-ink text-t-2xl">
    ...
    return (
        <div className="w-full space-y-6 px-12 py-8">
            <header className="flex flex-wrap items-start justify-between gap-4">
                <div className="min-w-0">
                    <h1 className="flex items-center gap-2.5 font-black uppercase tracking-display text-ink text-t-3xl">
            ...
            >
                <ul className="grid gap-2.5 grid-cols-3">
