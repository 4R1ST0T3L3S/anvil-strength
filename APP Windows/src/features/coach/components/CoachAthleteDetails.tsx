...
export function CoachAthleteDetails({ athleteId, onOpenChat, onBack }: CoachAthleteDetailsProps) {
    ...
    return (
        <div className="flex flex-col h-full">
            ...
            <div className="flex items-center justify-between gap-3 border-b border-subtle bg-surface-sunken shrink-0 p-6">
                <div className="flex min-w-0 items-center gap-3">
                    ...
                    <button
                        ...
                        className="group flex min-w-0 flex-1 items-center rounded-field px-1.5 py-1 -ml-1.5 text-left transition-colors duration-fast ease-snap hover:bg-surface-raised gap-4"
                    >
                        {athlete.avatar_url ? (
                        ...
                        <div className="min-w-0">
                            <span className="flex items-center gap-1.5">
                                <h2 className="font-black uppercase tracking-tight truncate text-xl">{athlete.full_name}</h2>
                                <ChevronDown
                                    size={16}
                                    aria-hidden="true"
                ...
                >
                    ...
                    <span className="inline">Mensaje Directo</span>
                </button>
            </div>
 ...
 isCurrent ? 'bg-[var(--brand-quiet)]' : 'hover:bg-surface-raised'
            ...
            {/* PESTAÑAS DE LA FICHA — fila propia, ancho completo.
                ...
                nada más. */}
            <div className="border-b border-subtle bg-surface-sunken pb-3 shrink-0 px-6">
                        ...
                        {visibleTabs.map(({ key, label, icon: Icon }) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`flex h-11 flex-1 items-center justify-center gap-2 whitespace-nowrap rounded-field text-t-sm font-bold transition-colors duration-fast ease-snap px-6 ${
 active
 ...
 : 'text-ink-subtle hover:bg-surface-raised hover:text-ink'
            ...
            <div className="flex-1 overflow-y-auto overflow-x-hidden bg-surface-sunken p-6">
                            ...
                            <div className="space-y-3 rounded-xl border border-subtle bg-surface-sunken p-4">
                                <div className="grid gap-3 grid-cols-3">
                                    <input
                                        ...
                                        className="rounded-field border border-[var(--border-default)] bg-surface-raised px-3 py-2 text-t-sm text-ink col-span-1"
                                    />
                                    <input
                                        type="date"
                                        ...
                                        <div key={comp.id} className={`bg-surface-sunken border ${meta.border} rounded-xl p-6 space-y-4 hover:border-[var(--border-strong)] transition-colors`}>
                                            <div className="flex justify-between gap-4 flex-row items-center">
                                                ...
                                                <button
                                                    ...
                                                    className="flex items-center gap-2 px-4 py-2 bg-[var(--danger-quiet)] hover:bg-[var(--danger-quiet)] text-danger-text rounded-lg transition-colors text-sm font-bold uppercase tracking-wide group shrink-0 self-center"
                                                >
