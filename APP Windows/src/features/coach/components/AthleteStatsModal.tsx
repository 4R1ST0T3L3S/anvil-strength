...
function ChartCard({ title, subtitle, children }: { title: string; subtitle?: string; children: React.ReactNode }) {
    return (
        <section className="rounded-card border border-[var(--border-default)] bg-surface-raised p-6">
            ...
            <header className={embedded ? 'shrink-0' : 'shrink-0 border-b border-subtle bg-surface-raised'}>
                {!embedded && (
                    <div className="flex items-center justify-between gap-4 py-4 px-8">
                        <h2 className="flex min-w-0 items-center gap-2.5 font-black uppercase tracking-display text-ink text-t-2xl">
                ...
                <div role="tablist" aria-label="Vista de estadísticas" className={embedded ? 'flex gap-1 overflow-x-auto pb-2' : 'flex gap-1 overflow-x-auto pb-2 px-8'}>
            ...
            {loading ? (
                ...
                <div className="flex min-h-0 flex-1 flex-row">
                    ...
                    {(tab === 'exercises' || tab === 'compare' || tab === 'velocity') && (
                        <aside className="flex max-h-56 shrink-0 flex-col border-subtle bg-surface-sunken p-4 max-h-none w-72 border-b-0 border-r">
