  ...
  return (
    <div className="flex w-full flex-col gap-3 pb-2">
      ...
      {/* UNA COLUMNA EN EL MOVIL. Con `grid-cols-3` fijo, a 375 px cada
          ...
          numero. */}
      <div className={`grid gap-3 shrink-0 grid-cols-3 ${dimmed}`}>
      ...
      {/* ALTO PROPIO, Y NO `flex-1`. Con la raiz en alto natural no queda
          ...
          leen. */}
      <div className={`grid gap-3 grid-cols-2 ${dimmed}`}>
          {/* Velocity Line Chart */}
          ...
          <div className="bg-surface-sunken border border-subtle p-3 rounded-xl flex flex-col items-center h-[260px] overflow-hidden">
              ...
              <div className="flex-1 min-h-[100px] w-full aspect-square bg-surface-sunken rounded-xl flex items-center justify-center border border-subtle max-w-[300px]">
                  <ResponsiveContainer width="100%" height="100%">
      ...
      <div className={`grid gap-2 shrink-0 grid-cols-4 ${dimmed}`}>
          {/* Potencia */}
          <div className="bg-surface-sunken border border-warning/20 py-2 px-3 rounded-xl flex flex-col justify-center shadow-[0_4px_20px_rgba(234,179,8,0.03)]">
              ...
              <div className="flex items-baseline gap-1">
                 <p className="font-black text-ink text-xl">{Math.round(advMetrics.dynamics.meanPower)}</p>
                 <span className="font-bold text-ink-subtle text-xs">/ {Math.round(advMetrics.dynamics.peakPower)} W</span>
              </div>
          </div>
          ...
          <div className="bg-surface-sunken border border-orange-500/20 py-2 px-3 rounded-xl flex flex-col justify-center shadow-[0_4px_20px_rgba(249,115,22,0.03)]">
              ...
              <div className="flex items-baseline gap-1">
                 <p className="font-black text-ink text-xl">{Math.round(advMetrics.dynamics.peakForce)}</p>
                 <span className="font-bold text-ink-subtle text-xs">N</span>
              </div>
          </div>
          ...
          <div className="bg-surface-sunken border border-blue-400/20 py-2 px-3 rounded-xl flex flex-col justify-center shadow-[0_4px_20px_rgba(96,165,250,0.03)]">
              ...
              <div className="flex items-baseline gap-1">
                 <p className="font-black text-ink text-xl">{Math.round(advMetrics.dynamics.rfd)}</p>
                 <span className="font-bold text-ink-subtle text-xs">N/s</span>
              </div>
          </div>
          ...
          <div className="bg-surface-sunken border border-danger/20 py-2 px-3 rounded-xl flex flex-col justify-center shadow-[0_4px_20px_rgba(239,68,68,0.03)]">
              ...
              <div className="flex flex-col">
                 {advMetrics.concentric.minVelocity !== null ? (
                   <>
                     <p className="font-black text-ink text-xl">{advMetrics.concentric.minVelocity.toFixed(2)}<span className="font-bold text-ink-muted ml-1 text-xs">m/s</span></p>
                   ...
                   <>
                     <p className="font-black text-ink text-xl">—</p>
          ...
          <div className="bg-surface-sunken border border-purple-500/20 py-2 px-3 rounded-xl flex flex-col justify-center shadow-[0_4px_20px_rgba(168,85,247,0.03)]">
              ...
              <div className="flex items-baseline gap-1">
                 <p className="font-black text-ink text-xl">{advMetrics.concentric.horizontalDeviationCm.toFixed(1)}</p>
                 <span className="font-bold text-ink-subtle text-xs">cm</span>
              </div>
          </div>
          ...
          <div className="bg-surface-sunken border border-teal-500/20 py-2 px-3 rounded-xl flex flex-col justify-center shadow-[0_4px_20px_rgba(20,184,166,0.03)]">
              ...
              <div className="flex items-baseline gap-1">
                 <p className="font-black text-ink text-xl">{advMetrics.eccentric ? advMetrics.eccentric.duration.toFixed(2) : '—'}<span className="text-t-2xs text-ink-subtle ml-0.5">s</span></p>
                 <span className="font-bold text-ink-subtle text-xs">/ {advMetrics.concentric.duration.toFixed(2)}s</span>
              </div>
          </div>
          ...
          <div className="bg-surface-sunken border border-pink-500/20 py-2 px-3 rounded-xl flex flex-col justify-center shadow-[0_4px_20px_rgba(236,72,153,0.03)]">
              ...
              <div className="flex items-baseline gap-1">
                 <p className="font-black text-ink text-xl">{Math.max(0, advMetrics.fatigue).toFixed(1)}</p>
                 <span className="font-bold text-ink-subtle text-xs">%</span>
              </div>
          </div>
          ...
          <div className={`bg-gradient-to-br from-brand/20 to-orange-500/20 border-2 border-brand/40 py-2 px-3 rounded-xl flex flex-col justify-center shadow-[0_0_30px_rgba(220,38,38,0.1)] ${advMetrics.rm.reliable ? '' : 'opacity-60'}`}>
              ...
              <div className="flex items-baseline gap-1">
                 <p className="font-black text-ink drop-shadow-md text-2xl">{Math.round(advMetrics.rm.rm)}</p>
                 <span className="font-bold text-ink-muted text-xs">Kg ({Math.round(advMetrics.rm.percent)}%)</span>
              </div>
