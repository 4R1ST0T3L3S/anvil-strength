...
export function CalibrationModal({ open, onClose, result, athleteId, coachId }: CalibrationModalProps) {
    ...
    return (
        <div
            className="fixed inset-0 z-[250] flex justify-center bg-black/80 backdrop-blur-sm items-center p-4"
            onClick={onClose}
        >
            <div
                onClick={e => e.stopPropagation()}
                className="flex max-h-[94vh] w-full max-w-2xl flex-col overflow-hidden border border-subtle bg-surface-raised shadow-overlay rounded-card"
            >
                ...
                <div className="min-h-0 flex-1 space-y-4 overflow-y-auto p-4">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className="mt-1.5 w-full rounded-field border border-subtle bg-surface-sunken px-3 py-2 text-ink transition-colors duration-fast focus:border-brand-line text-t-xs"
                        />
                    </div>
                    ...
                    <div>
                        ...
                        {parsed && parsed.sets.length > 1 && (
                            <select
                                ...
                                className="mt-2 w-full rounded-field border border-subtle bg-surface-sunken px-3 py-2 font-semibold text-ink text-t-xs"
                            >
                                {parsed.sets.map((s, i) => (
                        ...
                        <div className="space-y-3">
                            ...
                            {report.metrics.map(({ metric, agreement }) => {
                                ...
                                return (
                                    <div key={metric} className="rounded-card border border-subtle bg-surface-sunken p-3">
                                        ...
                                        {agreement ? (
                                            <>
                                                <dl className="mt-2 grid gap-x-3 gap-y-1 grid-cols-4">
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    className="mt-1.5 w-full resize-y rounded-field border border-subtle bg-surface-sunken px-3 py-2 text-ink transition-colors duration-fast focus:border-brand-line text-t-xs"
                                />
                            </div>
                        </div>
                    )}
