 ...
 : 'border-subtle bg-surface-sunken text-ink-muted hover:text-ink'
                    ...
                    <div className="flex items-center gap-2">
                        <div className="flex overflow-hidden rounded-field border border-subtle bg-surface-sunken">
                            ...
                            <input
                                ...
                                className="w-24 bg-transparent text-center font-bold tabular-nums text-ink text-t-sm"
                            />
                            <button
                                type="button"
                ...
                >
                    <select
                        ...
                        className="w-full rounded-field border border-subtle bg-surface-sunken px-3 py-2 font-semibold text-ink transition-colors duration-fast focus:border-brand-line text-t-xs"
                    >
                        {BAR_TYPES.map(b => (
