                ...
                <div className="flex flex-row items-center justify-between gap-4 px-5 py-4">
                    <div className="flex min-w-0 items-center gap-4">
                        ...
                        <div className="flex min-w-0 flex-col gap-0.5">
                            <h4 className="truncate font-bold text-ink transition-colors duration-fast group-hover:text-brand-text text-t-lg">
                                {block.name}
                            </h4>

                            <div className="flex items-center truncate text-t-xs text-ink-subtle gap-3">
                                ...
                                */}
                                {block.start_week && block.end_week && block.start_date && (
                                    <>
                                        <span className="h-1 w-1 shrink-0 rounded-pill bg-[var(--border-strong)] block" aria-hidden="true" />
                    ...
                    <div className="relative flex shrink-0 items-center justify-end gap-1">
                        ...
                        <ChevronRight size={18} aria-hidden="true" className="ml-1 shrink-0 text-ink-faint transition-colors duration-fast group-hover:text-ink-muted block" />
            ...
            >
                <div className="space-y-6">
                    ...
                    {macros.map(macro => {
                        ...
                        return (
                            <div key={macro.id} className="rounded-card border border-[var(--border-default)] bg-surface-sunken p-4">
