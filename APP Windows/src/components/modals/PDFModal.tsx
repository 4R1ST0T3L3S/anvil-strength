            ...
            {isOpen && (
                <div className="fixed inset-0 z-[9999] flex items-center justify-center p-6">
                    ...
                    <m.div
                        ...
                        className="relative w-full bg-surface-sunken shadow-2xl overflow-hidden flex flex-col border h-[90vh] max-w-5xl rounded-2xl border-line"
                    >
                        {/* Header */}
                        <div className="flex items-center justify-between p-4 bg-surface-sunken border-b border-line shrink-0 z-10">
                            <h3 className="font-black text-ink uppercase italic tracking-wider truncate mr-4 text-xl">
                                {title}
                            </h3>
                        ...
                        <div className="bg-surface-raised p-2 flex items-center justify-between border-b border-subtle shrink-0 px-4">
                            <div className="flex items-center gap-2 text-ink text-sm font-medium">
                                <span className="text-gray-400 inline">Página</span>
                        ...
                        {/* Footer Navigation */}
                        {numPages && numPages > 1 && (
                            <div className="p-4 bg-surface-sunken border-t border-line flex justify-center items-center gap-6 shrink-0 z-10 pb-4">
                                <button
