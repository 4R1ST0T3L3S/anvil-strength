    ...
    return createPortal(
        ...
        >
            ...
            >
                ...
                <div className="space-y-6 max-h-[70vh] overflow-y-auto custom-scrollbar p-6">
                    {/* General Info */}
                            ...
                            <div className="grid gap-2 grid-cols-4">
                                {[
                                    ...
                                    <button
                                        ...
                                        className={`p-2 rounded-xl border-2 flex flex-col items-center gap-2 transition-colors ${settings.shape === s.id ? 'border-brand bg-brand/10' : 'border-transparent bg-white/5 hover:bg-white/10'}`}
                                    >
                ...
                <div className="bg-surface-sunken border-t border-subtle flex gap-3 p-6">
                    <button
                        onClick={onClose}
                        className="flex-1 rounded-xl font-bold uppercase text-xs tracking-widest text-ink-muted hover:text-ink transition-colors px-6 py-4"
                    >
                        Cancelar
                    </button>
                    <button
                        onClick={handleSave}
                        disabled={isSaving}
                        className="flex-1 bg-brand text-ink rounded-xl font-black uppercase text-xs tracking-[0.2em] flex items-center justify-center gap-2 hover:bg-red-500 transition-colors shadow-[0_0_30px_rgba(220,38,38,0.3)] px-6 py-4"
                    >
                        {isSaving ? (
