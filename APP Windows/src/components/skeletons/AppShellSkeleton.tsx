    ...
    return (
        ...
        >
            ...
            <div className="flex min-w-0 flex-1 flex-col">
                ...
                <header className="z-40 h-16 shrink-0 items-center justify-between gap-3 border-b border-subtle bg-surface-canvas/90 px-6 backdrop-blur flex">
                ...
                <main className="flex-1 overflow-hidden bg-surface-canvas p-6">
