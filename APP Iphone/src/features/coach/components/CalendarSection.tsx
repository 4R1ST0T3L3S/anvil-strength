                                ...
                                <div className="flex flex-col gap-3 md:gap-4">
                                    ...
                                    <div className="flex justify-between items-start">
                                        <div className="flex flex-col gap-1.5">
                                            <div className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-t-2xs md:text-xs font-semibold ${bg} ${color}`}>
                                                {icon && icon}
                                                {level}
                                            </div>
                                            {esInvitado && (
                                                <div className={`flex items-center gap-1.5 ${bg} ${color} text-t-2xs font-semibold px-2.5 py-1 rounded-lg border border-subtle`}>
                                        ...
                                        <div className="flex items-center gap-2 text-ink font-semibold bg-[var(--fill-muted)] border border-subtle px-3 py-1.5 rounded-xl shrink-0 text-t-xs shadow-inner">
                                    ...
                                    <div className="mt-0.5">
                                        <h3 className="text-xl md:text-2xl font-semibold text-ink tracking-tight leading-tight">
                                            {comp.campeonato}
                                        </h3>
                                    </div>
                                    ...
                                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 md:gap-0">
                                        <div className="flex items-center gap-2 text-ink font-semibold text-t-xs md:text-sm">
                                        ...
                                        <div className="flex items-center gap-2 self-end md:self-auto">
                                            {user?.role === 'coach' && (
                                                <button
                                                    ...
                                                    className="px-6 py-2 bg-brand text-ink text-t-xs font-semibold rounded-xl hover:bg-brand-hover transition-[background-color,transform] shadow-lg active:scale-95"
                                                >
                                                    Asignar
                                                </button>
                                            )}
                                            {user?.role === 'athlete' && (
                                                <button
                                                    ...
                                                    className="px-6 py-2 bg-ink text-surface-canvas text-t-xs font-semibold rounded-xl hover:opacity-90 transition-[background-color,opacity,transform] active:scale-95 flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg"
                                                >
