...
export function ClaimAthletePage() {
    ...
    return (
        <div className="flex min-h-[100dvh] pt-[env(safe-area-inset-top,0px)] pb-[env(safe-area-inset-bottom,0px)] items-center justify-center bg-surface-canvas px-4 py-12">
            <m.div
