...
import { isAthlete } from '../../../lib/roles';
                    ...
                    <AthleteHome
                        ...
                        headerActions={
                            <div className="flex items-center gap-1">
                                ...
                                {/* Oculto por debajo de `sm`, mismo criterio que en
                                    CoachDashboard y que el armazón: en 375px ya hay
                                    tres controles en la fila y el tema es el que
                                    menos se toca. En móvil se cambia desde Perfil →
                                    Este dispositivo. */}
