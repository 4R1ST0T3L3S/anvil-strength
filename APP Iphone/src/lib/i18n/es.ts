...
export const es = {
    ...
    'tema.sistemaPista': 'Sigue al dispositivo',
    'tema.claro': 'Claro',
    'tema.claroPista': 'Siempre claro',
    'tema.oscuro': 'Oscuro',
    'tema.oscuroPista': 'Siempre oscuro',
    'tema.cambiar': 'Tema: {actual}. Cambiar',
    ...
    // Aviso de instalación (solo iPhone, fuera de la app instalada). iOS no
    // tiene diálogo de "instalar": hay que enseñar el camino del menú Compartir.
    'pwa.instalarTitulo': 'Instala Anvil Strength en tu iPhone',
    'pwa.instalarPasos': 'Pulsa Compartir y luego «Añadir a pantalla de inicio». Así abre a pantalla completa, funciona sin cobertura y recibe avisos.',
    'pwa.instalarCerrar': 'Cerrar aviso',
