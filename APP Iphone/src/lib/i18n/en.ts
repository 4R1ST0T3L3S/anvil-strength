...
export const en: DiccionarioTraducido = {
    ...
    'pwa.instalarTitulo': 'Install Anvil Strength on your iPhone',
    'pwa.instalarPasos': 'Tap Share, then "Add to Home Screen". It opens full screen, works offline and can receive notifications.',
    'pwa.instalarCerrar': 'Dismiss',
