...
export default {
  /**
   * HOVER SOLO DONDE HAY RATÓN. En iPhone no existe el hover: al tocar, el
   * navegador aplica `hover:` y lo deja PEGADO hasta que se toca otra cosa —
   * el botón se queda "iluminado" tras pulsarlo. Con esto Tailwind envuelve
   * cada `hover:` en `@media (hover: hover)`, y en táctil no se aplica.
   */
