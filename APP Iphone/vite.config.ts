...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      /**
       * ACTIVADO PARA PWA EN IPHONE.
       *
       * Esta variante es PWA web para usuarios de iPhone. El precacheo es
       * necesario para funcionar offline y tener la app instalable en el
       * home screen. Los cambios sobre la variante Android:
       * - PWA activa (service worker, manifest, caching)
       * - Orientación portrait para iPhone
       * - Meta tags Apple en index.html para ios (apple-mobile-web-app-capable)
       */
      disable: false,
      /**
      ...
      manifest: {
        ...
        description: 'Club de powerlifting digital: entrenamiento, análisis de vídeo y comunidad',
        lang: 'es',
        theme_color: '#0a0a0a',
      ...
      workbox: {
        maximumFileSizeToCacheInBytes: 10 * 1024 * 1024, // 10MB (iOS tiene menos memoria)
        /**
         * Web Push en iPhone (iOS 16.4+, solo con la app en pantalla de
         * inicio). `usePushNotifications` suscribe con VAPID por la rama web,
         * pero SIN estos manejadores dentro del service worker la suscripción
         * se hace y el aviso nunca se enseña. La variante Android los había
         * quitado porque avisa por Firebase; aquí vuelven. Mismo fichero que
         * en la raíz: public/push-sw.js. Requiere VITE_VAPID_PUBLIC_KEY.
         */
