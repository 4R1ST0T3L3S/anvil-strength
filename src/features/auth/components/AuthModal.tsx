    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-[#0a0a0a] w-full max-w-md max-h-[90vh] overflow-y-auto rounded-xl border border-white/10 shadow-2xl p-8">
          ...
          {!isLogin && (
            <div className="space-y-4 animate-in fade-in slide-in-from-top-2 duration-300">
              <div className="grid grid-cols-2 gap-4">
                <select
                  className="w-full bg-[#0a0a0a] border border-white/10 text-white px-3 py-2 rounded-lg text-sm focus:outline-none focus:border-anvil-red transition-colors [&>option]:bg-[#0a0a0a] [&>option]:text-white [&>optgroup]:bg-[#0a0a0a] [&>optgroup]:text-white"
                  value={formData.age_category}
                  onChange={(e) => setFormData({ ...formData, age_category: e.target.value })}
                  required
                >
                  <option value="" disabled className="bg-[#0a0a0a] text-gray-500">Cat. Edad</option>
                  <option value="Sub-Junior" className="bg-[#0a0a0a] text-white">Sub-Junior</option>
                  <option value="Junior" className="bg-[#0a0a0a] text-white">Junior</option>
                  <option value="Senior" className="bg-[#0a0a0a] text-white">Senior (Open)</option>
                  <option value="Master 1" className="bg-[#0a0a0a] text-white">Master 1</option>
                  <option value="Master 2" className="bg-[#0a0a0a] text-white">Master 2</option>
                  <option value="Master 3" className="bg-[#0a0a0a] text-white">Master 3</option>
                  <option value="Master 4" className="bg-[#0a0a0a] text-white">Master 4</option>
                </select>
                ...
                <select
                  ...
                  required
                >
                  <option value="" disabled className="bg-[#0a0a0a] text-gray-500">Cat. Peso</option>
                  <optgroup label="Masculino" className="bg-[#0a0a0a] text-anvil-red font-bold">
                    <option value="-59kg" className="bg-[#0a0a0a] text-white">-59kg</option>
                    <option value="-66kg" className="bg-[#0a0a0a] text-white">-66kg</option>
                    <option value="-74kg" className="bg-[#0a0a0a] text-white">-74kg</option>
                    <option value="-83kg" className="bg-[#0a0a0a] text-white">-83kg</option>
                    <option value="-93kg" className="bg-[#0a0a0a] text-white">-93kg</option>
                    <option value="-105kg" className="bg-[#0a0a0a] text-white">-105kg</option>
                    <option value="-120kg" className="bg-[#0a0a0a] text-white">-120kg</option>
                    <option value="+120kg" className="bg-[#0a0a0a] text-white">+120kg</option>
                  </optgroup>
                  <optgroup label="Femenino" className="bg-[#0a0a0a] text-anvil-red font-bold">
                    <option value="-47kg" className="bg-[#0a0a0a] text-white">-47kg</option>
                    <option value="-52kg" className="bg-[#0a0a0a] text-white">-52kg</option>
                    <option value="-57kg" className="bg-[#0a0a0a] text-white">-57kg</option>
                    <option value="-63kg" className="bg-[#0a0a0a] text-white">-63kg</option>
                    <option value="-69kg" className="bg-[#0a0a0a] text-white">-69kg</option>
                    <option value="-76kg" className="bg-[#0a0a0a] text-white">-76kg</option>
                    <option value="-84kg" className="bg-[#0a0a0a] text-white">-84kg</option>
                    <option value="+84kg" className="bg-[#0a0a0a] text-white">+84kg</option>
                  </optgroup>
                </select>
              </div>
              ...
              <textarea
                ...
                rows={4}
                className="w-full bg-[#0a0a0a] border border-white/10 text-white px-3 py-2 rounded-lg text-sm focus:outline-none focus:border-anvil-red resize-none"
                value={formData.bio}
        ...
        <button
          ...
          disabled={isLoading || isGoogleLoading}
          className="w-full bg-[#0a0a0a] hover:bg-[#111] text-white border border-white/10 font-black uppercase py-4 rounded-xl transition-colors flex items-center justify-center gap-3 shadow-lg"
        >
          {isGoogleLoading ? (
