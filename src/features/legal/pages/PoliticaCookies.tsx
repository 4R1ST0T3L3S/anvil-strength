    ...
    return (
        <div className="font-sans min-h-[100dvh] bg-[#0a0a0a] text-gray-300">
            ...
            <div className="max-w-3xl mx-auto px-6 pt-40 pb-24">
                <h1 className="text-4xl font-black text-white uppercase tracking-tighter mb-12">Política de Cookies</h1>

                <div className="space-y-8 text-sm leading-relaxed">
                    <section>
                        <h2 className="text-lg font-bold text-white uppercase mb-3">1. ¿Qué son las cookies?</h2>
                    ...
                    <section>
                        <h2 className="text-lg font-bold text-white uppercase mb-3">2. Cookies que utilizamos</h2>
                        <p>Este sitio web utiliza exclusivamente las siguientes cookies:</p>
                        <div className="mt-4 overflow-x-auto">
                            <table className="w-full text-xs">
                                <thead>
                                    <tr className="border-b border-white/10 text-left">
                                        <th className="text-white font-bold py-2 pr-4">Cookie</th>
                                        <th className="text-white font-bold py-2 pr-4">Tipo</th>
                                        <th className="text-white font-bold py-2 pr-4">Finalidad</th>
                                        <th className="text-white font-bold py-2">Duración</th>
                                    </tr>
                                </thead>
                                <tbody className="divide-y divide-white/5">
                                    <tr>
                                        <td className="py-2 pr-4 font-mono text-anvil-red">sb-*-auth-token</td>
                                    ...
                                    <tr>
                                        <td className="py-2 pr-4 font-mono text-anvil-red">aep_calendar_data</td>
                    ...
                    <section>
                        <h2 className="text-lg font-bold text-white uppercase mb-3">3. Cookies de terceros</h2>
                        <p>Utilizamos <strong className="text-white">Vercel Analytics</strong> para medir el rendimiento del sitio web. Vercel Analytics <strong className="text-white">no utiliza cookies</strong> y no recopila datos personales identificables; funciona exclusivamente con datos agregados y anonimizados del lado del servidor.</p>
                    ...
                    <section>
                        <h2 className="text-lg font-bold text-white uppercase mb-3">4. Gestión de cookies</h2>
                    ...
                    <section>
                        <h2 className="text-lg font-bold text-white uppercase mb-3">5. Más información</h2>
                        <p>Para cualquier consulta sobre el uso de cookies, puede escribirnos a <a href="mailto:anvilstrengthclub@gmail.com" className="text-anvil-red hover:underline">anvilstrengthclub@gmail.com</a>.</p>
                    </section>
