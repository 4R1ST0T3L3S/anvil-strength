        ...
        <div className="font-sans min-h-[100dvh] bg-[#0a0a0a] text-gray-300">
            ...
            <div className="max-w-3xl mx-auto px-6 pt-40 pb-24">
                ...
                <div className="space-y-8 text-sm leading-relaxed">
                    <section>
                        <h2 className="text-lg font-bold text-white uppercase mb-3">1. Datos identificativos</h2>
                        ...
                        <ul className="mt-3 space-y-1 list-disc pl-5">
                            <li><strong className="text-white">Denominación:</strong> Grupo de Recreación Deportiva de Halterofilia Anvil Strength</li>
                            ...
                            <li><strong className="text-white">Email de contacto:</strong> anvilstrengthclub@gmail.com</li>
                            <li><strong className="text-white">Sitio web:</strong> https://anvilstrength.es</li>
                        </ul>
                    </section>

                    <section>
                        <h2 className="text-lg font-bold text-white uppercase mb-3">2. Objeto</h2>
                    ...
                    <section>
                        <h2 className="text-lg font-bold text-white uppercase mb-3">3. Propiedad intelectual e industrial</h2>
                    ...
                    <section>
                        <h2 className="text-lg font-bold text-white uppercase mb-3">4. Condiciones de uso</h2>
                    ...
                    <section>
                        <h2 className="text-lg font-bold text-white uppercase mb-3">5. Responsabilidad</h2>
                    ...
                    <section>
                        <h2 className="text-lg font-bold text-white uppercase mb-3">6. Legislación aplicable y jurisdicción</h2>
