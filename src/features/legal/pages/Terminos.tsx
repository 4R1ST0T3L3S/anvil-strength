...
export function Terminos({ onLoginClick }: LegalPageProps) {
    useSeo({
    ...
    return (
        <div className="font-sans min-h-screen bg-[#0a0a0a] text-gray-300">
            ...
            <div className="max-w-3xl mx-auto px-6 pt-40 pb-24">
                <h1 className="text-4xl font-black text-white uppercase tracking-tighter mb-12">Términos y Condiciones de Uso</h1>

                <div className="space-y-8 text-sm leading-relaxed">
                    <section>
                        <h2 className="text-lg font-bold text-white uppercase mb-3">1. Objeto y aceptación</h2>
                        <p>Estos términos regulan el acceso y uso de la plataforma de Anvil Strength (el "Servicio"), operada por el Grupo de Recreación Deportiva de Halterofilia Anvil Strength (ver identificación completa en el <a href="/legal/aviso-legal" className="text-anvil-red hover:underline">Aviso Legal</a>). Al crear una cuenta, el usuario acepta estos términos en su totalidad. Si no está de acuerdo, no debe registrarse ni utilizar el Servicio.</p>
                    </section>

                    <section>
                        <h2 className="text-lg font-bold text-white uppercase mb-3">2. Qué es el Servicio, y qué no es</h2>
                        ...
                        <p className="mt-3"><strong className="text-white">El entrenamiento personalizado con un entrenador es un servicio distinto</strong>, prestado por cada entrenador a título individual y acordado directamente entre el entrenador y el atleta (precio, forma de pago y condiciones). La plataforma facilita la relación —programación, seguimiento, comunicación— pero no interviene como parte en ese acuerdo económico ni procesa cobros por él.</p>
                    </section>

                    <section>
                        <h2 className="text-lg font-bold text-white uppercase mb-3">3. Registro y cuenta de usuario</h2>
                        <ul className="space-y-1 list-disc pl-5">
                            ...
                            <li>El usuario puede solicitar la baja de su cuenta en cualquier momento escribiendo a <a href="mailto:anvilstrengthclub@gmail.com" className="text-anvil-red hover:underline">anvilstrengthclub@gmail.com</a>.</li>
                        </ul>
                    </section>

                    <section>
                        <h2 className="text-lg font-bold text-white uppercase mb-3">4. Datos de salud y rendimiento deportivo</h2>
                        <p>El Servicio trata datos relativos a marcas, cargas de entrenamiento, categoría de peso, vídeos de series y respuestas a cuestionarios de bienestar (check-ins), que pueden constituir datos de salud a efectos del artículo 9 del RGPD. Al completar estos campos, el usuario presta su consentimiento explícito para ese tratamiento, con la única finalidad de prestar el servicio de entrenamiento. Puede ampliar esta información en la <a href="/legal/privacidad" className="text-anvil-red hover:underline">Política de Privacidad</a>.</p>
                    </section>

                    <section>
                        <h2 className="text-lg font-bold text-white uppercase mb-3">5. Contenido generado por el usuario</h2>
                    ...
                    <section>
                        <h2 className="text-lg font-bold text-white uppercase mb-3">6. Uso aceptable</h2>
                    ...
                    <section>
                        <h2 className="text-lg font-bold text-white uppercase mb-3">7. Limitación de responsabilidad</h2>
                    ...
                    <section>
                        <h2 className="text-lg font-bold text-white uppercase mb-3">8. Modificación de estos términos</h2>
                    ...
                    <section>
                        <h2 className="text-lg font-bold text-white uppercase mb-3">9. Legislación aplicable</h2>
