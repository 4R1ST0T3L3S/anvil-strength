            ...
            {isOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                    ...
                    <m.div
                        ...
                        className="relative w-full max-w-md bg-[#0a0a0a] border border-line rounded-[2.5rem] overflow-hidden shadow-2xl max-h-[90vh] overflow-y-auto custom-scrollbar"
                    >
                        {/* Header */}
                        <div className="p-8 border-b border-subtle relative">
                            <button 
                                onClick={onClose}
                                className="absolute top-8 right-8 text-ink-subtle hover:text-ink transition-colors"
                            >
                                <X size={24} />
                            </button>
