    ...
    return (
        <AnimatePresence mode="wait">
            <m.div
                ...
                className={`group relative flex items-center gap-2 px-4 py-2 bg-black/40 backdrop-blur-xl border border-white/10 rounded-full shadow-[0_0_20px_rgba(0,0,0,0.5)] hover:border-yellow-500/50 transition-colors duration-slow ${className}`}
            >
