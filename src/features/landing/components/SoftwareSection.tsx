                ...
                <div className="w-full max-w-5xl">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
                        ...
                        <div className="bg-[#0a0a0a] border border-white/5 rounded-2xl p-6 flex flex-col items-center justify-center gap-4 relative overflow-hidden group">
                            ...
                            <div className="bg-anvil-red/10 border border-anvil-red/30 text-anvil-red text-t-2xs font-black uppercase tracking-[0.2em] px-3 py-1 rounded-full w-max mt-2">
                                Próximamente
                            </div>
                        </div>
