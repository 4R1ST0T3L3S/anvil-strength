    ...
    return (
        <section id="software" className="py-32 bg-[#050505] relative overflow-hidden">
            ...
            <div className="max-w-[1400px] mx-auto px-6 relative z-10 flex flex-col items-center">
                ...
                >
                    <div className="absolute inset-0 bg-anvil-red/10 blur-[100px] rounded-[3rem] pointer-events-none group-hover:bg-anvil-red/20 transition-colors duration-slow" />
                    <img 
                        src="/image.png" 
                ...
                <div className="w-full max-w-5xl">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
                        ...
                        <div className="bg-surface-sunken border border-subtle rounded-2xl p-6 flex flex-col items-center justify-center gap-4 relative overflow-hidden group">
                            ...
                            <div className="bg-anvil-red/10 border border-anvil-red/30 text-brand-text text-t-2xs font-black uppercase tracking-[0.2em] px-3 py-1 rounded-full w-max mt-2">
                                Próximamente
                            </div>
                        </div>
