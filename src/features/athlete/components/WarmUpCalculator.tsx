...
export function WarmUpCalculator({ isOpen, onClose }: WarmUpCalculatorProps) {
    ...
    return (
        ...
        >
            <div className="bg-[#1c1c1c] border-2 border-white/10 w-full h-full md:w-[95vw] md:h-[95vh] md:max-w-2xl md:rounded-[3rem] shadow-[0_0_100px_rgba(255,0,0,0.15)] overflow-hidden flex flex-col scale-in-center mt-14 md:mt-0">
