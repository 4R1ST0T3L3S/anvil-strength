...
export function WarmUpCalculator({ isOpen, onClose }: WarmUpCalculatorProps) {
    ...
    return (
        ...
        >
            <div className="bg-[#1c1c1c] border-x-0 md:border-2 border-t border-white/10 w-full h-full md:h-[95vh] md:w-[95vw] md:max-w-2xl md:rounded-[3rem] shadow-[0_0_100px_rgba(255,0,0,0.15)] overflow-hidden flex flex-col scale-in-center mt-0">
                            ...
                            {warmUpSets.length > 0 ? (
                                warmUpSets.map((set, i) => (
                                    <motion.div 
                                        ...
                                        className={`flex items-center justify-between p-5 md:p-6 rounded-[1.5rem] border-2 transition-all ${
                                            set.percentage === 100 
                                    ...
                                    >
                                        <div className="flex items-center gap-4 md:gap-6">
                                            <div className={`w-10 h-10 md:w-12 md:h-12 rounded-xl flex items-center justify-center font-black italic text-lg md:text-xl ${
                                                set.percentage === 100 ? 'bg-blue-600 text-white' : 'bg-white/5 text-gray-500'
                                            }`}>
                                                {i + 1}
                                            </div>
                                            <div>
