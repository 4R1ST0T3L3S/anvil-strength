...
export function PlateCalculator({ isOpen, onClose }: PlateCalculatorProps) {
    ...
    return (
        ...
        >
            <div className="bg-[#1c1c1c] border-x-0 md:border-2 border-t border-white/10 w-full h-full md:h-[95vh] md:w-[95vw] md:max-w-4xl md:rounded-[3rem] shadow-[0_0_100px_rgba(255,0,0,0.15)] overflow-hidden flex flex-col scale-in-center mt-0">
