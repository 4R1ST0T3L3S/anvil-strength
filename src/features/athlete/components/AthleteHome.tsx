                ...
                <div className="lg:col-span-2 space-y-4">
                    ...
                    {todaySession ? (
                        <div 
                            ...
                            className="bg-[#252525] border border-white/5 rounded-2xl overflow-hidden hover:border-anvil-red/30 transition-all group cursor-pointer active:scale-[0.99]"
                        >
                        ...
                        <div className="bg-[#252525] border border-white/5 rounded-2xl p-12 text-center space-y-4">
