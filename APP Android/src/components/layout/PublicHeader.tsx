...
export function PublicHeader({ onLoginClick, onSignupClick }: PublicHeaderProps) {
 ...
 ? 'bg-surface-sunken/90 backdrop-blur-md border-subtle pt-[calc(env(safe-area-inset-top,0px)+0.75rem)] pb-3 shadow-overlay'
 : 'bg-transparent border-transparent pt-[calc(env(safe-area-inset-top,0px)+1.5rem)] pb-6'
 }`}
        >
