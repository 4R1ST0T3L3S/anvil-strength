        ...
        <div className="flex flex-col h-full bg-surface-sunken">
            ...
            <div className="border-b border-subtle bg-surface-sunken p-6">
                <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                        <div className="flex items-center gap-3">
                            <h2 className="text-xl font-semibold text-ink tracking-tight leading-none">
                                {block.name}
                            </h2>
                            {block.is_active && (
                                <span className="bg-brand/20 text-brand-text text-t-2xs font-semibold px-2 py-0.5 rounded">
                                    Activo
                                </span>
                            )}
                        </div>
                ...
                <div className="flex gap-8 text-sm">
                    <div>
                        <span className="block text-ink-subtle text-xs font-bold">Días / S</span>
                        <span className="text-ink font-bold text-lg">{sessions.length}</span>
                    </div>
                    <div>
                        <span className="block text-ink-subtle text-xs font-bold">Volumen</span>
            ...
            <div className="flex-1 overflow-y-auto p-6">
                ...
                <div className="flex items-center justify-between mb-6">
                    <h3 className="text-lg font-bold text-ink tracking-tight">Estructura semanal</h3>
                    <button
                            ...
                            >
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-4">
                                        <div className="w-12 h-12 bg-surface-sunken rounded-lg flex flex-col items-center justify-center border border-subtle text-center">
                                            <span className="text-t-2xs text-ink-subtle font-bold">Día</span>
                                            <span className="text-xl font-semibold text-ink leading-none">{session.day_number}</span>
                                        </div>
                                        <div>
                                            <h4 className="text-ink font-bold text-lg">
