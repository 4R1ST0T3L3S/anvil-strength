            ...
            {loading ? (
                ...
                <div className="grid grid-cols-1 gap-4">
                    {competitions.map((comp, index) => {
                        ...
                        return (
                            <div key={index} className={`relative bg-surface-sunken border-y border-r ${border} border-l-[6px] ${line} p-4 md:p-5 rounded-[1.5rem] transition-[background-color,border-color,opacity] hover:bg-surface-raised hover:border-r-white/10 ${esInvitado ? 'opacity-70' : ''}`}>
                                <div className="flex flex-col gap-3 md:gap-4">

                                    {/* SECCIÓN SUPERIOR: Badges y Fecha */}
                                    <div className="flex justify-between items-start">
                                        <div className="flex flex-col gap-1.5">
                                            <div className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-t-2xs md:text-xs font-black uppercase tracking-widest ${bg} ${color}`}>
                                                {icon && icon}
                                                {level}
                                            </div>
                                            {esInvitado && (
                                        ...
                                        <div className="flex items-center gap-2 text-ink font-black uppercase tracking-widest bg-white/5 border border-subtle px-3 py-1.5 rounded-xl shrink-0 text-t-xs shadow-inner">
                                    ...
                                    <div className="mt-0.5">
                                        <h3 className="text-xl md:text-2xl font-black text-ink uppercase tracking-tighter leading-tight italic">
                                            {comp.campeonato}
                                        </h3>
                                    </div>
                                    ...
                                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 md:gap-0">
                                        <div className="flex items-center gap-2 text-ink font-black uppercase text-t-xs md:text-sm tracking-widest">
