...
// La URL de opencv la pone quien crea el worker (src/lib/cv/tracker.ts): en
// el navegador es `/opencv.js`; en el APK, la copia que sirve la web.
self.importScripts(new URL(self.location.href).searchParams.get('opencv') || '/opencv.js');
